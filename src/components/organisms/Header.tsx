...
export function Header() {
  return (
    <header className="flex h-10 w-full shadow-md shadow-main tablet:h-[60px] dark:shadow-dark-main">
      <PageWidthContainer styles="flex justify-between items-center">
